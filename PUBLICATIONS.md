...
## Master Cross-Affiliation Ledger
...
*Affiliation: Independent Researcher · Repo: aaron-slusher-research · License: CC BY-NC-ND 4.0*
...
**APA:**
```
Slusher, A. M. (Year). Title. Affiliation. https://doi.org/10.5281/zenodo.[ID]
```

**BibTeX:**
```bibtex
@article{slusher[year][shortname],
  title={},
